...
```powershell
pyinstaller --clean --onefile --console --name audioctl --collect-all pycaw --collect-submodules comtypes --hidden-import comtypes --hidden-import comtypes.gen --hidden-import comtypes.automation --icon audio.ico --add-data "audio.ico;." --version-file version.txt audioctl.py
```
